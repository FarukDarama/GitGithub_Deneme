...
public class P07 {
    public static void main(String[] args) {
       ...
       WebElement addButton = driver.findElement(By.xpath("//*[text()='Add Element']"));
        ...
        Assert.assertEquals(deleteButtons.size(),100);
        ...
        List<WebElement> deleteButtonList =driver.findElements(By.xpath("//*[@class='added-manually']"));
        int kalanDeleteButton = deleteButtons.size()-90;
