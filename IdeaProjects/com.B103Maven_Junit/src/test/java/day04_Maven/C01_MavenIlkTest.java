...
public class C01_MavenIlkTest {
    public static void main(String[] args) {
        ...
        List<WebElement> sayfaBaslıklariListesi = driver.findElements(By.xpath("//h1"));
         for (WebElement w:sayfaBaslıklariListesi){
             System.out.print(w.getText());
         }
        sayfaBaslıklariListesi.forEach(t-> System.out.println(t.getText()));//Lambda ile yapılmıs hali
